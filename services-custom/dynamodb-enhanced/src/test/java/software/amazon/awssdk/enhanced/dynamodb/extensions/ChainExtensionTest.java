...
import software.amazon.awssdk.enhanced.dynamodb.internal.operations.OperationType;
...
public class ChainExtensionTest {
    ...
    private DefaultDynamoDbExtensionContext getWriteExtensionContext(int i) {
        return getExtensionContext(i, OperationType.BATCH_WRITE_ITEM);
    }
    ...
    private DefaultDynamoDbExtensionContext getExtensionContext(int i, OperationType operationType) {
        ...
        if (operationType != null) {
            context.operationType(OperationType.BATCH_WRITE_ITEM);
        }
